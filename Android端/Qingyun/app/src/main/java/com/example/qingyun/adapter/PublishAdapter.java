...
import com.example.qingyun.activity.ModifyActivity;
...
public class PublishAdapter extends RecyclerView.Adapter<PublishAdapter.ViewHolder>{
    ...
    private static final String deleteProductUrl= AppConfig.BaseUrl+"/deleteProduct.php";

    public PublishAdapter(List<Product> productList, Context context) {
    ...
    public void onBindViewHolder(@NonNull PublishAdapter.ViewHolder holder, int position) {
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                asyncHttpClient.post(deleteProductUrl, requestParams, new AsyncHttpResponseHandler() {
                    @Override
                    public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                        // 将 byte 数组转换为字符串
                        String responseString = new String(responseBody);
                        Log.d("delete",responseString);
                        try{
        ...
        // 修改商品按钮点击事件
        Button modifyButton = holder.itemView.findViewById(R.id.buttonModify);
