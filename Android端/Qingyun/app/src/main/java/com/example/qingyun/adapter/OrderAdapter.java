...
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.ViewHolder>{
    ...
    private static final String deleteOrderUrl= AppConfig.BaseUrl+"/deleteOrder.php";
    public OrderAdapter(List<Product> productList, Context context) {
    ...
    public void onBindViewHolder(@NonNull OrderAdapter.ViewHolder holder, int position) {
        ...
        holder.orderTimeTextView.setText("购买时间："+product.getSoldTime());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            orderTimeTextView=itemView.findViewById(R.id.textViewSoldTime);
